...
3. Enable code signing for `com.adplay.app` (App Store distribution). Use the **AdPlay_New** profile (the one with Sign in with Apple), not the older **AdPlay** profile.
